...
| 驾驶 | W A S D |
| 氮气加速 | Shift |
| 转动视角 / 瞄准（准星居中） | 鼠标（指针锁定） |
| 开火（弹药无限） | 鼠标左键 |
| 第一 / 第三人称切换 | V 或 C |

左下角雷达地图：地形底图 + 恐龙（红）/ UFO（青）/ 外星人（绿）/ 陨石 ◆ / 狮身人面像 ▲ / 神秘物体 ◇，扇形为当前视野。所有资源（含穿越视频）在标题屏预载完成后才允许进入，保证全程零卡顿。

- **恐龙**：八种地面恐龙（似鸡龙 / 迅猛龙 / 双冠龙 / 三角龙 / 剑龙 / 霸王龙 / 棘龙 / 腕龙），血量与体型成正比；**击中头部要害一发必杀**（×2 积分 + 慢动作），打躯干需多发。空中有翼龙群，可击落。双冠龙狩猎时张开颈伞；棘龙盘踞湖区浅滩。
- **蛇颈龙**：湖中巨影，定期浮出水面换气——只有浮出时可以命中，头部要害 +800。
- **恐龙蛋巢**：散布在丛林里，击碎恐龙蛋 +150 分，但有概率引来迅猛龙伏击。
- **火山**：远处的活火山周期性喷发，熔岩弹砸向荒原，落点附近会损伤车体。荒原上还有上古巨兽的白骨遗骸可供辨认方向。
...
| `assets/timewarp.mp4` | Veo 3.1 via `video-vertex` — 时空穿越过场（1920×1080 crf23，约 7MB；58MB 原片留档 `.masters/`，**同步到 marginalia 时须 `--exclude '.masters'`**） |
